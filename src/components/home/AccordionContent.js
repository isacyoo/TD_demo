export const accordionContent = [
    { title: "How does the system work?", content: <div className="flex flex-col gap-4 text-sm text-primary/80 font-light">
        ...
        <p>To see the overall architecture of the system, please visit <a href="/architecture" className="underline">Architecture</a></p>
    </div> },
    { title: "Have you got an API reference?", content: <div className="flex flex-col gap-4 text-sm text-primary/80 font-light">
        <p>Yes! We do have API reference, which you can find <a href="/api-reference" className="underline">here</a>. In order to try out the APIs:</p>
        <ol className="list-decimal list-inside space-y-2">
            <li>First create a demo environment using <a href="/demo" className="underline">API</a> page</li>
            <li>Go to <strong>{"<API_URL>/settings/api"}</strong> and issue a new API key</li>
    ...
    { title: "Could you explain some of the jargons?", content: <div className="flex flex-col gap-4 text-sm text-primary/80 font-light">
        ...
        <ul className="list-disc list-inside space-y-2">
            <li><strong>Tailgating:</strong> A security breach where an unauthorized person {"(regardless of whether they are legitimate member of employee)"} follows an authorized person into a restricted area.</li>
    ...
    { title: "Is there a demo I can try?", content: <div className="flex flex-col gap-4 text-sm text-primary/80 font-light">
        <p>Yes! You can try out the demo by clicking on the <a href="/demo" className="underline">Demo</a> page. The demo is a fully functional version of the system, but you will be required to present an access key to create a demo environment.</p>
