export const pagesInfo = [
    ...
    { name: "Manage high-risk members", pathInDemo: "/settings/members", description: "Add, modify, and delete high-risk members nad configure settings for system's behaviour for them.", img: "/members.png", path: "/pages/members" }
]