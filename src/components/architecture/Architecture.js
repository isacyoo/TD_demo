                        ...
                        <CardContent>
                            ...
                            <Card className="my-4 p-4">
                                <ol className="list-decimal list-inside space-y-2">
                                    ...
                                    <li>The SQS queue is configured to trigger another Lambda function that creates a clip from the KVS stream using the <ALink href="https://docs.aws.amazon.com/kinesisvideostreams/latest/dg/API_reader_GetClip.html" blank>GetClip</ALink> API.</li>
